...
export const links = [
  ...
  <NavLink className='tabs-bar__link secondary' exact to='/timelines/tag/メイドインアビス考察班' data-preview-title-id='column.consideration' data-preview-icon='comments' ><i className='fa fa-fw fa-comments' /><FormattedMessage id='tabs_bar.consideration_timeline' defaultMessage='Consideration' /></NavLink>,
