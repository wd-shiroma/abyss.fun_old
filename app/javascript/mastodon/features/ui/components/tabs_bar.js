...
export const links = [
  ...
  <NavLink className='tabs-bar__link secondary' exact to='/timelines/tag/abyss_fun' data-preview-title-id='column.old_local_timeline' data-preview-icon='comments' ><i className='fa fa-fw fa-comments' /><FormattedMessage id='tabs_bar.old_community_timeline' defaultMessage='Old local' /></NavLink>,
